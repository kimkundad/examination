...
<div class="intro2 m_h" id="intro" data-scroll-index="0" style="background: url('{{ url('img/HeadBanner.png') }}'); background-position: center;">
            <div class="container">
        ...
        <div class="d_h new-product ban_top section-padding">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-12" style="    padding-right: 0px; padding-left: 0px;">
                    <img class="img-fluid" src="img/HeadBanner.png" alt="">
                    </div>
                </div>
            </div>
            </div>

        <div class="exchange-form box_search">
            <div class="container">
        ...
        <div class="market section-padding page-section" data-scroll-index="1">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        <div class="section-title2 section-title text-center">
        ...
        <div class="intro2 m_h" id="intro" data-scroll-index="0" style="background: url('{{ url('img/5f245240e1126513387227.png') }}'); background-position: center;">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-7 col-lg-12">
                                <div class="intro-content text-center">
            ...
            <div class="d_h new-product section-padding">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-12" style="    padding-right: 0px; padding-left: 0px;">
                    <img class="img-fluid" src="img/5f245240e1126513387227.png" alt="">
                    </div>
                </div>
            </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-7">
                        <div class="section-title2 section-title">
                            <h2>วันนี้ ครูพี่โฮมมีข้อสอบใหม่อะไรบ้าง?</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        <img class="img-fluid" src="{{ url('img/pngwing.com.png') }}" alt="">
                            <h4>แบบฝึกหัดใหม่ทุกวัน</h4>
                            <p>เพื่อความทันสมัยของเนื้อหา ข้อสอบ  เราได้ทำการ คัดกรอง ค้นหาแนวข้อสอบ เพิ่มเนื้อหา ข้อสอบภาษาญี่ปุ่นออนไลน์ ให้กับนักเรียน ให้เยอะที่สุด </p>
                            <a href="{{ url('about_us') }}" class="btn btn-success px-4">รู้จักเรามากขึ้น</a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <div class="new-product-content">
                            <img class="img-fluid" src="{{ url('img/reporting.png') }}" alt="">
                            ...
                            <a href="{{ url('examination') }}" class="btn btn-outline-success px-4">เริ่มทำข้อสอบกัน</a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="testimonial2 owl-carousel owl-theme">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        <div class="customer-review">
                                            <img class="img-fluid" src="" alt="">
                                            <p>เนื้อหาข้อสอบครบ หลากหลาย เพื่อนๆสามารถลองมาทำข้อสอบ เพื่อวัดผลกันได้นะครับ มาสนุกด้วยกัน</p>
                                            <div class="customer-info">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4">
                        <div class="trust-content">
                            ...
                            <h4>ใช้งานง่าย</h4>
                            <p>สร้างบัญชี เข้าไปทำ ข้อสอบ ภาษาญี่ปุ่นออนไลน์ พร้อมเฉลย เก็บสถิติการทำข้อสอบ
                            </p>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-4">
